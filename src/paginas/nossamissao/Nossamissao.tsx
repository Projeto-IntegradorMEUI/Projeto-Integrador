...
function Nossamissao() {
  return (
    <>
    <Grid container justifyContent='center' alignItems='center' className='wallpaperfundo2'>
    <Grid alignItems="center" item xs={6}>
     <Box paddingX={0}>
 
     <Typography variant='h3' gutterBottom color='textPrimary' component='h3' align='center' className='textos2'><h5>Nossa Missão</h5></Typography>
